...
public abstract class AbstractChat extends JFrame {
    ...
    private JPanel makeBtnPanel() {
        ...
        JButton btnClose = new JButton("�رմ���");
    ...
    protected void initViews() {
        ...
        JSplitPane jSpPane = new JSplitPane(JSplitPane.VERTICAL_SPLIT,
                hisPanel, msgPanel);
        jSpPane.setDividerLocation(320);   //���÷ָ�����λ�� ...
    ...
    private void createStyle(String styName, StyledDocument doc,
        ...
        Style sty = doc.addStyle(styName, sys);    //[1] ������ʽ���ĵ�
        StyleConstants.setFontSize(sty, size);     //[2] ���������С
        StyleConstants.setForeground(sty, color);  //[3] ����������ɫ
