...
public class ChartFrame extends JFrame{
	...
	//private JTextField txtOtherMsg;
	...
	public ChartFrame(String nickName){
		...
		/*txtOther.setFont(new Font("楷书",Font.BOLD,22));
		txtOtherMsg.setFont(new Font("宋体",Font.BOLD,28));
		txtSelf.setFont(new Font("楷书",Font.BOLD,22));
		txtSelfMsg.setFont(new Font("宋体",Font.BOLD,28));
		btnSend.setFont(new Font("楷书",Font.BOLD,22));*/
		
		txtOther.setBounds(20, 10, 100, 20);
		otherScroll.setBounds(20, 50, 400, 150);
		//txtOtherMsg.setBounds(20, 50, 400, 150);
